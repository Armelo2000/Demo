 ...
 * @Param: num_bytes - represent the number of byte in string.
 * @Return: return type uint16_t - return the calculated crc value.
 *
 ...
 * bytes to check is also a parameter.
 */
 ...
 * @Param: input_str - Pointer to the input string.
 * @Param: num_bytes - represent the number of byte in string.
 * @Return: return type uint16_t - return the calculated 16 bits Modbus CRC value.
 *
 ...
 *
 * @Param:  crc - previous value of crc.
 * @Param:	c - new byte within the new crc should be calculated.
 * @Return: return type uint16_t - return the new CRC-16 value.
 *
